...
uint256 hashGenesisBlock("0x85259388819b65eff7317a94cd51d9fcb064bd5e1a77e013bc9e52fb7c1f8223");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(520343692); // Fastbit: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Fastbit Signed Message:\n";
...
{
    // Fastbit: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 20000); // Fastbit: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 30240; // Fastbit: 3.5 days
static const int64 nTargetSpacing = 150; // Fastbit: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Fastbit: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Fastbit: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Fastbit: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x47eed039c1a056dcd7f549a3c2e1bf15b70136cff132a6bf90da8bd6562f2871");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Washington Post 012517 Trumps moves to crack down on immigrants";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1000000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0dc9b3302e885bd60a7415a4862e77174fafcc41f400fc1c20c2e250bbb9e818f7ab55645972dde37d7a582f495c301163206c71bf859041898762f07aafacdf4a") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1485372864;
        block.nBits    = 520343692;
        block.nNonce   = 1943360911;

        if (fTestNet)
        {
            block.nTime    = 1485372864;
            block.nNonce   = 2106089729;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x1177b98f88a2cdfa32da0f203e0049e3859707914eda85ee6dd10864b1c95366"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Fastbit: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FastbitMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FastbitMiner : ProcessBlock, block not accepted");
    }
